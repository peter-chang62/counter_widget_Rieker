...
#        qPolicy.setHeightForWidth(True)
        ...
        self.curve_fdf.setPen(Qt.QPen(Qt.Qt.black))
...
#        self.curve_0dB.setPen(self.qplot_tf)
        ...
        self.qchk_bKpCrossing = Qt.QCheckBox('fi and fd refer to kp crossover')
...
#        grid.setRowStretch(0, 1)
        ...
        grid.addWidget(self.qslider_kp,         1, 2, 2, 1)
        grid.addWidget(self.qlabel_spacerv,     0, 2, 1, 1)
        
        grid.addWidget(self.qchk_kp,            1, 0, 1, 2)
