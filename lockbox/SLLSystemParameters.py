...
class SLLSystemParameters():
    ...
    def __init__(self):
        ...
        self.root.append(ET.Element('Reference_frequency', DDC0='25e6', DDC1='25e6'))
        self.root.append(ET.Element('Beat_frequency_modulation_range', DAC0='3e8', DAC1='0.5e6', DAC2='9e6'))
        self.root.append(ET.Element('Output_limits_low', DAC0='-1.1', DAC1='0', DAC2='0'))
        self.root.append(ET.Element('Output_limits_high', DAC0='0', DAC1='8', DAC2='55'))
        self.root.append(ET.Element('Input_Output_gain', ADC0='1', ADC1='1', DAC0='2', DAC1='8'))
        self.root.append(ET.Element('Output_offset_in_volts', DAC0='-0.75', DAC1='4', DAC2='27'))
        self.root.append(ET.Element('PLL0_settings', kp='10', fi='45e3', fii='3.4e3', fd='1', fdf='1', chkKd='False', chkKp='True', chkLock='False', chkKpCrossing='True'))
