...
#        self.qlbl_actual_frequency.setMaximumWidth(60)
        ...
        self.qchk_Wideband1 = Qt.QRadioButton('Wideband (25 MHz)')
        self.qchk_Narrowband1 = Qt.QRadioButton('Narrowband (6 MHz)')
        self.qchk_WidebandFIR1 = Qt.QRadioButton('Wideband FIR (50 MHz)')
