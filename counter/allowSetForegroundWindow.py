...
# Taken from
# https://bitbucket.org/tortoisehg/thg/src/232b9d263a5fbd05f39ebce5d7e6b053d813da3a/tortoisehg/hgqt/qtapp.py
def allowSetForegroundWindow():
    ...
    # processid = -1 also doesn't seem to work, but it works when I use the
    # actual process ID of the current process.
    if os.name == "nt":
