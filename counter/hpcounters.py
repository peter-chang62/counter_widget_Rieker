...
#                sys.exc_clear()
    ...
    def set_config_default(self):
        ...
        self.counter.write(":STAT:PRES") # Preset enable registers and transition filters for operation and questionable status structures.
        ...
        self.counter.write(":DIAG:CAL:INT:AUTO OFF") # Disable automatic interpolater calibration. The most recent calibration values are used in the calculation of frequency
        ...
        self.counter.write(":DISP:ENAB OFF") # Turn off the counter display. This greatly increases measurement throughput.
        ...
        self.counter.write("*DDT #15FETC?") # Define the Trigger command. This means the command FETC? does not need to be sent for every measurement, decreasing the number of bytes transferred over the bus. Can use "READ?" command too.
